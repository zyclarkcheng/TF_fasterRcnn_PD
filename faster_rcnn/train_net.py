...
#python ./faster_rcnn/train_net.py --gpu 0 --weights ./data/pretrain_model/VGG_imagenet.npy 
#--imdb kittivoc_train --iters 50000 --cfg ./experiments/cfgs/faster_rcnn_kitti.yml 
...
if __name__ == '__main__':
    ...
    network = get_network(args.network_name)#--------instance the class VGGnet_train----------------------------------
