...
class SolverWrapper(object):
    ...
    def __init__(self, sess, network, imdb, roidb, output_dir, logdir, pretrained_model=None):
        ...
        self.net = network#VGGnet_train
        self.imdb = imdb#kittivoc_train
        self.roidb = roidb
        self.output_dir = output_dir
        self.pretrained_model = pretrained_model#./data/pretrain_model/VGG_imagenet.npy 
...
#------------------------------------------------------------------------------------
    def train_model(self, sess, max_iters, restore=False):
        ...
        if cfg.TRAIN.SOLVER == 'Adam':
            ...
            opt = tf.train.MomentumOptimizer(lr, momentum)#------------------------optimizer
        ...
        if with_clip:
            ...
            train_op = opt.minimize(loss, global_step=global_step)#-------------------train object
